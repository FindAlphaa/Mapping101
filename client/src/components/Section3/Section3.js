...
const Section3 = () => {
	return (
		<div className={styles.section3}>
			<div className={`${styles.utility} ${styles.enlargeOnHover}`}>
			...
			<div className={`${styles.energy} ${styles.enlargeOnHover}`}>
			...
			<div className={`${styles.consumerGoods} ${styles.enlargeOnHover}`}>
